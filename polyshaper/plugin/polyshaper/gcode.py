...
class CuttingGCodeGenerator(object):
    ...
    be in millimeters. This does not add any point to path (not even return to (0, 0))
    """

    def __init__(self, tool_path, speed):
        """ Constructor
